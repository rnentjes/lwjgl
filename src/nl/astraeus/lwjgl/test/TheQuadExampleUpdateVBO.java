package nl.astraeus.lwjgl.test;
...
public class TheQuadExampleUpdateVBO {
    ...
    private void setupTextures() {
        texIds[0] = this.loadPNGTexture("assets/blue.png", GL13.GL_TEXTURE0);
        texIds[1] = this.loadPNGTexture("assets/red.png", GL13.GL_TEXTURE0);
    ...
    private void setupShaders() {
        ...
        vsId = this.loadShader("shaders/vertex_textured.glsl", GL20.GL_VERTEX_SHADER);
        // Load the fragment shader
        fsId = this.loadShader("shaders/fragment_textured.glsl", GL20.GL_FRAGMENT_SHADER);
